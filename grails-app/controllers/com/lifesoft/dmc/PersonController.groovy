...
class PersonController {
    ...
    def save(Person person) {
        ...
        if (person.hasErrors()) {
            dmcService.getUncheckedFields(person)
            transactionStatus.setRollbackOnly()
    ...
    def update(Person person) {
        ...
        dmcService.updateBooleanFields(person, params)
    ...
    def analysSTEMI() {
        AnalysedData analysedData = dataAnalyserService.analyseSTEMI()
        respond analysedData
    }

    def analysNonSTEMI() {
        AnalysedData analysedData = dataAnalyserService.analyseNonSTEMI()
        respond analysedData
    }
